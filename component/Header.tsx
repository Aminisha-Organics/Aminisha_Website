          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden mt-4 border-t pt-4">
              <nav className="flex flex-col space-y-4">
                ...
                <div onClick={() => window.location.href='tel:+919428323829'} className="flex items-center gap-3 bg-white border border-blue-600 text-blue-600 px-5 py-2 rounded-xl shadow-sm">
